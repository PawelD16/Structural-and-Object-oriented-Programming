...
public class Tablica_dwuwymiarowa {
    ...
    static double[][] transcript_array(double[][] tab) {


        double[][] tab2 = new double[tab[0].length][tab.length];
    ...
    static double[][] bubble_sort_columns(double[][] tab) {

        double[][] tab_rtc = new double[tab[0].length][tab.length];

        tab_rtc = transcript_array(tab);
        tab_rtc = bubble_sort(tab_rtc);
        tab = transcript_array(tab_rtc);
